...
TravelMind v1 的唯一终极目标是交付一个稳定、可泛化、可解释、可调试的旅行规划 Agent：

- 在多轮对话中稳定维护旅行目标，正确区分问答、局部修改、目的地切换、闲聊和重置；
...
完整范围、验收标准和停止条件见：
[TravelMind v1 Final Delivery Goal](docs/superpowers/specs/2026-07-27-travelmind-v1-final-delivery-goal-design.md)。
